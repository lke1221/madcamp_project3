...
function Login({ history }) {
  ...
  return (
    ...
    >
      ...
      <div>
        {message.length > 0 && <span className="errorMessage">{message}</span>}
      </div>
      <div>
        <button
          type="button"
      ...
      >
        <Link to="/signup">
          <small style={{ fontSize: 18, textDecorationLine: "underline" }}>
            New to madcamp? Sign Up
          </small>
        </Link>
      </div>
      <div
      ...
      >
        <Link to="/changepassword">
          <small style={{ fontSize: 18, textDecorationLine: "underline" }}>
            Can't remember your password? Change Password
          </small>
        </Link>
      </div>
    </div>
